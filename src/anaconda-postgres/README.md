...
_Note: This file was auto-generated from the [devcontainer-template.json](https://github.com/ecampuslearning/ProjectOperation/blob/main/src/anaconda-postgres/devcontainer-template.json).  Add additional notes to a `NOTES.md`._
